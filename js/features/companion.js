...
(function () {
    ...
    const MODES = {
        study:    {
            ...
            icon:  'fa-book-open',
            hint:  '正在一起学习 · 加油',
            times: [15,30,60,90],               // 用户可选
            inviteTimes: [15, 30, 60],           // 梦角主动邀请时随机选
        },
        work:     {
            label: '一起工作',
            icon:  'fa-laptop-code',
    ...
    function openTimeModal(mode, onSelected) {
        ...
        const html = `
            ...
            <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin:10px 0 18px;">${timesHtml}</div>
            <div style="margin-top:18px;text-align:right;">
